...
#+begin_src R :session *R* :tangle no :exports none :eval yes
  ...
  setwd("~/tools/web2py/applications/data_inventory/static/")
  dir()
  prj <-  "Air_Pollution_Monitoring_Stations_NSW" #"Air pollution modelling: LUR_Western_Sydney" # "Air pollution from biomass smoke"
  dset <- "AP_monitor_NSW_2014_2015" # "LUR_Western_Sydney_passive_samplers"  # "biomass_smoke_events_database"
  # walkability_osm  
...
#+end_src
** checkout from master to child, replaces child
#+begin_src R :session *R* :tangle no :exports none :eval yes
  require(swishdbtools)
  ...
  # get datasets
  dsets  <- dbGetQuery(ch_source,
                       paste("select * from dataset where project_id = ",pid[1,1], sep = "")
                       )
  dsets
