...
#+end_src
*** COMMENT eml/dataset/entity fin
**** COMMENT entity code
#+begin_src markdown :tangle ~/tools/web2py/applications/data_inventory/models/db.py :exports reports :eval no :padline no
...
#+begin_src R :session *R* :tangle no :exports none :eval yes
  cat(sprintf('
  pg_dump -h localhost -p 5432 -U postgres -F t -v -i -f "/home/ivan_hanigan/Dropbox/data/data_inventory/hanigan/backups/backup_file-%s.backup" -n "public" data_inventory_hanigan_dev
  ',gsub(":","-",gsub(" ","-",Sys.time()))))
