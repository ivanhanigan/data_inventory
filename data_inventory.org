...
*** Manging Projects form
#+begin_src R :session *R* :tangle controllers/default.py :exports reports :eval no :padline no
  
  #def manage_projects():
  #    grid = SQLFORM.smartgrid(db.project,linked_tables=['dataset'],
